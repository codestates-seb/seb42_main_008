...
import partypeople.server.review.controller.ReviewController;
...
class SubscriberControllerTest {
    ...
    void postSubscriberTest() throws Exception {
        ...
        actions
            ...
            .andDo(document("post-subscriber",
    ...
    void getSubscribersTest() throws Exception {
        ...
        MvcResult result = actions
            ...
            .andDo(document("get-subscribers",
                getRequestPreProcessor(),
                getResponsePreProcessor(),
                pathParameters(
                    parameterWithName("companion-id").description("동행글 식별자")
    ...
    void patchSubscriberTest() throws Exception {
        ...
        actions
            .andExpect(status().isOk())
            .andDo(document("patch-subscriber",
                getRequestPreProcessor(),
                getResponsePreProcessor(),
                pathParameters(
                    parameterWithName("companion-id").description("동행글 식별자")
